...
%% Problem 1: Estimating the value of ヰ
% Function generates N random points in the square x ＃ [-1, 1] and y ＃ [-1, 1].
% Then we calculate how many of those points landed inside the unit circle.

%% (1) Express ヰ as a function of No and N.
% Ans) =(Nzero/N)*A=(Nzero/N)*4
% Nzero is the number of points landed inside the unit circle
% N is the number of points
% A is the area of square x ＃ [-1, 1] and y ＃ [-1, 1]
